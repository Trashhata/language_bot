...
from handlers import (other_handlers, user_handlers_registered, user_registration, lesson_handlers, user_info_handlers,
                      word_library_handlers, clear_library_handlers, new_word_add_handlers, language_handlers)
...
async def main():
    ...
    dp.include_router(user_info_handlers.router)
